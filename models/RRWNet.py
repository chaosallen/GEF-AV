...
by José Morano, Guilherme Aresta, and Hrvoje Bogunović
Published in Expert Systems with Applications (2024)

Repository: https://github.com/j-morano/rrwnet
'''
...
if __name__=="__main__":
    img = torch.randn((4,3,576,576))
    model = RRWNet(input_ch=3,output_ch=3,base_ch=64,iterations=5)
    out_list = model(img)
    print(out_list[0].shape,len(out_list))