...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--trainroot', default='G:\\AV Segmentation\\Data\\OCTA500\\train', help='path to data')
        parser.add_argument('--testroot', default='G:\\AV Segmentation\\Data\\OCTA500\\val', help='path to data')
        parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids')
        parser.add_argument('--input_filename', type=list, default=['OCTA(ILM_OPL)'], help='dataset filename')
        parser.add_argument('--label_filename', type=list, default=['Binary_A','Binary_V'],help='label filename')
        parser.add_argument('--energy_filename', type=list, default=['DEF_M','OEF_M'], help='label filename')
